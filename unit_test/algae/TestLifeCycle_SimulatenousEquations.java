...
public class TestLifeCycle_SimulatenousEquations extends TestCase {
	...
	public void testMultiplicity2Paraents2()
	{
		...
		var lc = new LifeCycle(parameters, 2, 2, CrossoverStrategy.CrossoverGametes, chromosomeFactories, phenoMapper, fitnessTester);
		
		runExperiment(lc, phenoMapper);
	}

	public void testMultiplicity1Paranets2()
	{
		...
		var lc =new LifeCycle(parameters, 1, 2, CrossoverStrategy.CrossoverParents, chromosomeFactories, phenoMapper, fitnessTester);
