...
public interface IParameters {
	...
	/**
	 * The crossover probability per allele for the given chromosome set. This value
	 * is checked at the beginning of each breeding cycle.
	 * 
	...
	/**
	 * The mutation probability per allele for the given chromosome set. This value
	 * is checked at the beginning of each breeding cycle.
	 * 
	 * @param chromosomeSetIndex The zero-based chromosome set index.
	 * @return The probability in the range [0.0, 1.0]
